    ...
    const exerciseDefs = [
        {
            ...
            executionType: client_1.ExecutionType.INTERVAL,
        },
        {
            ...
            category: 'Força',
            executionType: client_1.ExecutionType.SERIES_REPS,
        },
        {
            ...
            category: 'Core',
            executionType: client_1.ExecutionType.TIME_BASED,
        },
        {
            name: 'Tiros de 400m',
            ...
            executionType: client_1.ExecutionType.DISTANCE_BASED,
        },
        {
            ...
            category: 'Agilidade',
            executionType: client_1.ExecutionType.CIRCUIT,
        },
        {
            ...
            category: 'Mobilidade',
            executionType: client_1.ExecutionType.FREE_INSTRUCTIONS,
        },
    ];
    const exercises = [];
    ...
    if (!protocol) {
        ...
        const sessions = [
            {
                ...
                type: client_1.TrainingType.INTERVALADO,
            ...
            },
            {
                order: 2,
                name: 'Treino 2 — HIIT',
                type: client_1.TrainingType.HIIT,
            ...
            },
            {
                ...
                type: client_1.TrainingType.CORRIDA_RESISTIDA,
            ...
            },
            {
                ...
                type: client_1.TrainingType.AGILIDADE,
            ...
            },
            {
                ...
                type: client_1.TrainingType.MOBILIDADE_CORE,
        ...
        for (const s of sessions) {
            ...
            for (const exIdx of s.exerciseIndexes) {
                ...
                if (ex.executionType === client_1.ExecutionType.SERIES_REPS) {
                    await prisma.trainingExercise.create({
                        data: { ...base, sets: 4, repetitions: 8, restSeconds: 60 },
                    });
                }
                else if (ex.executionType === client_1.ExecutionType.TIME_BASED) {
                    await prisma.trainingExercise.create({
                        data: { ...base, sets: 3, durationSeconds: 45, restSeconds: 30 },
                    });
                }
                else if (ex.executionType === client_1.ExecutionType.DISTANCE_BASED) {
                    await prisma.trainingExercise.create({
                        data: {
                            ...base,
                            sets: 4,
                ...
                else if (ex.executionType === client_1.ExecutionType.CIRCUIT) {
                    await prisma.trainingExercise.create({
                        data: { ...base, rounds: 3, restSeconds: 90, notes: '3 voltas' },
                    });
                }
                else if (ex.executionType === client_1.ExecutionType.INTERVAL) {
                    await prisma.trainingExercise.create({
                        data: {
                            ...base,
                            sets: 8,
